...
/*
 * Auto-transformed by chatGPT on 20241214
...
pub struct LoopConstraint {
    #[serde(default)]
    pub minlength: i64, // Defaults to 0 -- minimum length of unaligned region
    #[serde(default = "default_max_length")]
    pub maxlength: i64, // Defaults to 100000 -- maximum length of unaligned region
}
...
pub struct CoreDef {
    pub nblocks: i64, // -- number of core elements/blocks
    pub blocks: Vec<CoreBlock>, // - nblocks locations
    pub loops: Vec<LoopConstraint>, // -- (nblocks+1) constraints
    pub is_discontinuous: Option<bool>, // -- is it a discontinuous domain
    pub insertions: Option<Vec<i64>>, // -- positions of long insertions
}

/// SiteAnnot structure
#[derive(Serialize, Deserialize, Debug, Clone, Default)]
pub struct SiteAnnot {
    pub start_position: i64, // -- location of the annotation
    pub stop_position: i64, // -- start and stop position in the PSSM
    pub description: Option<String>, // -- holds description or names, that can be used for labels in visualization
    pub r#type: Option<i64>, // -- type of the annotated feature,similarly to Align-annot in NCBI-Cdd
    pub aliases: Option<Vec<String>>, // -- additional names for the annotation
    pub motif: Option<String>, // -- motif to validate mapping of sites
    pub motif_use: Option<i64>,  // -- 0 for validation -- 1 for motif in seqloc -- 2 for multiple motifs in seqloc
}
